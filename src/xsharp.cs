...
namespace XSharp
{
  ...
  public class XColor : XHandle
  {
    ...
    public XColor (XDisplay dpy, Color color) : this(dpy, "")
    {
    }
  ...
  public class XDisplay : XHandle
  {
    ...
    [DllImport("libX11.so")]
    public static extern bool XkbSetDetectableAutoRepeat (IntPtr display, bool detectable, ref bool supported_rtrn);
  }
  #endregion
...
//    }
    ...
    [DllImport("libX11.so")]
    private static extern int XPeekEvent (IntPtr display,ref _XEvent e);
    [DllImport("libX11.so")]
